	...
	$GLOBALS['TCA']['tx_terfe2_domain_model_version'] = array(
		...
		'columns' => array(
			...
			'frontend_download_counter' => array(
				'exclude' => 1,
				'label'   => 'LLL:EXT:ter_fe2/Resources/Private/Language/locallang_db.xml:tx_terfe2_domain_model_version.frontend_download_counter',
				'config'  => array(
					'type' => 'none',
					'size' => 12,
				),
			...
			'has_zip_file' => array(
				'exclude' => 1,
				'label'   => 'LLL:EXT:ter_fe2/Resources/Private/Language/locallang_db.xml:tx_terfe2_domain_model_version.has_zip_file',
				'config'  => array(
					'type'    => 'check',
					'default' => 0,
				),
			...
			'has_images' => array(
				'exclude' => 1,
				'label'   => 'LLL:EXT:ter_fe2/Resources/Private/Language/locallang_db.xml:tx_terfe2_domain_model_version.has_images',
				'config'  => array(
					'type'    => 'check',
					'default' => 0,
				),
