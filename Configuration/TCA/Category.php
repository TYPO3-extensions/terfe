		...
		'columns' => array(
			...
			'l18n_parent' => array(
				...
				'config'      => array(
					...
					'foreign_table_where' => 'AND tx_terfe2_domain_model_category.uid=###REC_FIELD_l18n_parent### AND tx_terfe2_domain_model_category.sys_language_uid IN (-1,0)',
					'items'               => array(
						array('', 0),
					),
				),
			...
			'title' => array(
				'exclude' => 1,
				'label'   => 'LLL:EXT:ter_fe2/Resources/Private/Language/locallang_db.xml:tx_terfe2_domain_model_category.title',
				'config'  => array(
					'type' => 'input',
					'size' => 30,
					'eval' => 'trim,required',
